...
import 'package:zawadi/core/utils/router_utils.dart';
import 'package:zawadi/features/gift_cards/presentation/screens/incomplete_giftcards_screen.dart';
  ...
  late final GoRouter _router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (context, state) => const IncompleteGiftcardsScreeen()),

      GoRoute(
          path: APP_PAGE.notifications.routePath,
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return IssuersListScreen(categoryId: categoryId, title: title, issuerListType: IssuerListType.CATEGORY,);
        },
      ),
