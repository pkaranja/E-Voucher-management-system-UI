...
final ThemeData kiingilioTheme = _kiingilioTheme();

//Define Base theme for app
ThemeData _kiingilioTheme() {
  ...
  return base.copyWith(
    ...
    textTheme: _kiingilioTextTheme(base.textTheme),
...
// Outside of _kiingilioTheme function  create another function

TextTheme _kiingilioTextTheme(TextTheme base) => base.copyWith(
