...
import 'package:zawadi/pages/auth/providers/auth_provider.dart';
...
// Submit form will take AuthStateProvider, and BuildContext
  void _submitForm(
    ...
    if (isValid) {
      ...
      // Try Sigin Or Register based on if its register Auth Mode or not
      if (registerAuthMode) {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: Text(registerAuthMode ? "Sign In" : "Register"),
                      )
                    ],
                  )
                ],
