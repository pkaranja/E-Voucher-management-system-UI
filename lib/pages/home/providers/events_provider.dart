...
// Instantiate Temple Utils
 // final EventsUtils templesUtils = EventsUtils();
  // Create the fake list of temples
  //List<EventsModel>? _temples = [];
  // User location from db
  LatLng? _userLocation;
// FavTempList

// Getters
  //List<EventsModel> get temples => [..._temples as List];
...
// Future method to get temples
  Future<List?> getNearyByEvents(LatLng userLocation) async {
